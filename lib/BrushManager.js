...
BrushManager.prototype.getMarksNoGaps = function(self){
  ...
  self.brushes.forEach(function(brush,index){
	  ...
	  var bristlePositions = brush.pixelPositions; bristles = bristlePositions.length; 
	  var pixels = []; 
  	...
  	for (var bristle = 1; bristle < bristles; bristle++){
  		...
  		if(oldAxis != newAxis){pixels.push(utils.getPixel(flatAxis,oldAxis,self.width,self.height));}
