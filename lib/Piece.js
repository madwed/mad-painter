...
Piece.prototype.init = function(canvas_,uiCanvas_,red,green,blue,alpha,actions,randoms,life,size){
...
Piece.prototype.uiAddBrush = function(action,what,x,y,vel,random){
  ...
  manager.addBrush(new Brush(x-size/2,y,x+size/2,y,vel,Number(this.life.value)));
