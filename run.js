...
window.onload = function() {
  ...
  for(var i = 0; i < 100; i++){
    ...
    brushMan.addBrush(new Brush(pos,pos,pos+15,pos+15,new Vector(Math.random()-.5,Math.random()-.5),Infinity,Infinity,20,Math.random()*100));
  ...
  for(var i = 0; i < 100; i++){
    var pos = Math.random() * 800;
    brushMan1.addBrush(new Brush(pos,pos,pos+15,pos+15,new Vector(Math.random()-.5,Math.random()-.5),Infinity,Infinity,20,Math.random()*100));
